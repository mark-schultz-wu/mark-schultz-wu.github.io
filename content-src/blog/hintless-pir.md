...
date = 2023-11-14
aliases = ["/hintless-pir/"]
[taxonomies]
tags = ["FHE", "cryptography"]
+++
...
I’ve written some [blog posts](@/blog/nist-standard-out.md) on this in the past geared towards a general audience,
...
One almost always wants to keep polynomials in the evaluation representation {% mi() %}\widehat{R}_{n,q}{% end %}, as it has more efficient multiplication.
