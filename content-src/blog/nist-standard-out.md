...
date = 2022-07-05
aliases = ["/nist-standard-out/"]
[taxonomies]
tags = ["cryptography", "lattices"]
+++
...
* [Part 1](@/blog/lattices-for-programmers-pt1.md) discusses the base underlying hardness assumption (Learning with Errors) some.
* [Part 2](@/blog/lattices-for-programmers-pt2.md) constructs a simple lattice-based (private-key) cryptosystem, and
* [Part 3](@/blog/lattices-for-programmers-pt3.md) constructs a lattice-based (public-key) cryptosystem.
